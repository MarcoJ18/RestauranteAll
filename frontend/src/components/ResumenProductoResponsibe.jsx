...
export default function ResumenProductoResponsibe({producto}) {
    const {handleCambiarCantidadResponsive, hadleEliminarProductoPedido} = useQuiosco();
        ...
        <div className="shadow space-y-1 p-4 bg-white">
          ...
          <div className="flex justify-between gap-2 pb-4">
            <button
              ...
              onClick={() => handleCambiarCantidadResponsive(id)}
            >
              <svg
            ...
            <button
              ...
              onClick={() => hadleEliminarProductoPedido(id)}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
